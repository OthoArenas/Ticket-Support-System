...
?>
    ...
    ?>
            <table class="table table-striped jambo_table bulk_action table-bordered text-center table-responsive sortable-theme-bootstrap" data-sortable id="ticket-table" style="font-size:12px">
                <thead>
                    <tr class="headings">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr class="even pointer">
                            ...
                            <td><?php if (strtotime($r['updated_at']) == NULL) {
                                    echo "-";
                                } else {
                                    echo $updated_at . " " . $updated_at_hour;
                                } ?></td>
                            <td><?php if (strtotime($r['attended_at']) == NULL) {
                                    echo "-";
                                } else {
                                    echo $attended_at . " " . $attended_at_hour;
                                } ?></td>
                            <td><?php if (strtotime($r['closed_at']) == NULL) {
                                    echo "-";
                                } else {
