...
<head>
    ...
    <link rel="icon" type="image/png" href="images/logo DS.png" sizes="32x32">
...
<div class="bg-dark section" id="navbar_section">
    <div class="container" id="icon_container">
        <a href="#" data-target="slide-out" class="sidenav-trigger" id="logo_link"><i class="fas fa-ticket-alt fa-fw fa-4x hoverable"> </i><span id="nav_logo_name">GOLFO TICKET</span></a>
    ...
    <li>
        <div class="user-view">
            ...
            <div class="text-center justify-content-center">
                <a href="dashboard.php" class="site_title"><i class="fa fa-ticket-alt hoverable"></i> <span class="hoverable">Golfo Ticket</span></a>
